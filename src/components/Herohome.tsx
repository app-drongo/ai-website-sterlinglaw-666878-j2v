        ...
        <div className="grid items-center gap-12 py-20 sm:py-24 lg:grid-cols-2 lg:gap-20 lg:py-32">
          ...
          <div className="flex flex-col justify-center">
            ...
            <h1 className="text-4xl font-bold tracking-tight sm:text-5xl lg:text-6xl">
              Expert Corporate Legal Services for
            ...
            <p className="mt-6 max-w-xl text-lg leading-relaxed text-muted-foreground">
              Sterling & Associates provides comprehensive corporate law, intellectual property protection, and M&A advisory services to businesses of all sizes.
            </p>
            ...
            <div className="mt-8 flex flex-col gap-4 sm:flex-row">
              ...
              <Button size="lg" variant="outline" className="text-base">
                <Scale className="mr-2 size-5" /> View Practice Areas
              </Button>
            </div>
          </div>
            ...
            <div className="relative overflow-hidden rounded-2xl border bg-card shadow-2xl">
              <div className="aspect-[16/10] relative">
                <Image
                  ...
                  alt="Sterling & Associates Law Firm office"
                  fill
