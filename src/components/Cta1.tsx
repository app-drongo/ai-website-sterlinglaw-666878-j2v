...
import { ArrowRight, Scale, Users, Award, Shield } from "lucide-react"

export default function Cta1() {
  const stats = [
    { value: "500+", label: "Cases Won", icon: Award },
    { value: "25+", label: "Years Experience", icon: Scale },
    { value: "50+", label: "Expert Attorneys", icon: Users },
          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Our experienced attorneys specialize in corporate law, M&A, and intellectual property. 
                Schedule a consultation today and protect your business interests.
              </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Initial case review at no cost to you
              </p>
            </div>
