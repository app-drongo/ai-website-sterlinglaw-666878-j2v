...
export default function Cta() {
  const stats = [
    ...
    { value: "200+", label: "Corporate Clients", icon: Users }
  ]
          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Don't let legal challenges derail your success. Partner with Sterling & Associates 
                for comprehensive corporate legal services that safeguard your business interests.
              </p>
